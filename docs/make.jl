...
DocMeta.setdocmeta!(DirWorkflow, :DocTestSetup, :(using DirWorkflow); recursive = true)
...
makedocs(;
    ...
    repo = "https://github.com/singularitti/DirWorkflow.jl/blob/{commit}{path}#{line}",
    sitename = "DirWorkflow.jl",
    format = Documenter.HTML(; canonical = "https://singularitti.github.io/DirWorkflow.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/singularitti/DirWorkflow.jl")
